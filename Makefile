CC ?= cc
CFLAGS ?= -O3 -ffast-math -mcpu=native -Wall -Wextra -std=c99 -D_POSIX_C_SOURCE=200809L
...
LDLIBS += -ldl
CORE_OBJS = ds4.o ds4_cuda.o ds4_cuda_kernels.o
NATIVE_CORE_OBJS = ds4_native.o
METAL_LDLIBS := $(LDLIBS)
endif
...
ds4_cuda.o: ds4_cuda.c ds4_cuda.h
	$(CC) $(CFLAGS) -c -o $@ ds4_cuda.c

ds4_cuda_kernels.o: ds4_cuda_kernels.c ds4_cuda_kernels.h
	$(CC) $(CFLAGS) -c -o $@ ds4_cuda_kernels.c
